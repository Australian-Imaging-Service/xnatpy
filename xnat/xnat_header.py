...
class XNAT(object):
    ...
    def get(self, path, format=None, query=None):
        #print('[DEBUG] CALL GET {}'.format(path))
    ...
    def post(self, path, data, format=None, query=None):
        #print('[DEBUG] CALL POST {}'.format(path))
        uri = self._format_uri(path, format, query=query)
        try:
    ...
    def put(self, path, data=None, files=None, format=None, query=None):
        #print('[DEBUG] CALL PUT {}'.format(path))
        uri = self._format_uri(path, format, query=query)
        try:
    ...
    def delete(self, path):
        #print('[DEBUG] CALL DELETE {}'.format(path))
    ...
    def create_object(self, uri, type=None, **kwargs):
        ...
        if type not in XNAT_CLASS_LOOKUP:
            raise KeyError('Type {} unknow to this XNAT REST client (see XNAT_CLASS_LOOKUP global)'.format(type))

        return XNAT_CLASS_LOOKUP[type](uri, self, datafields=datafields, **kwargs)
...
class XNATObject(object):
    ...
    def get_str(self, name):
        return self.get(name, type_=str)

    def get_bool(self, name):
        return self.get(name, type_=self.to_bool)

    def get_int(self, name):
        return self.get(name, type_=int)

    def get_float(self, name):
        return self.get(name, type_=float)

    def get_datetime(self, name):
        return self.get(name, type_=self.to_datetime)

    def get_date(self, name):
        return self.get(name, type_=self.to_date)

    def get_time(self, name):
        return self.get(name, type_=self.to_time)

    def get_timedelta(self, name):
        return self.get(name, type_=self.to_timedelta)
    ...
    def set_str(self, name, value):
        self.set(name, value, str)

    def set_bool(self, name, value):
        self.set(name, value, self.from_bool)

    def set_int(self, name, value):
        self.set(name, value, self.from_int)

    def set_float(self, name, value):
        self.set(name, value, self.from_float)

    def set_datetime(self, name, value):
        self.set(name, value, self.from_datetime)

    def set_date(self, name, value):
        self.set(name, value, self.from_date)

    def set_time(self, name, value):
        self.set(name, value, self.from_time)

    def set_timedelta(self, name, value):
        self.set(name, value, self.from_timedelta)
